---
id: replit
title: How to Deploy a Smart Contract Using Replit
sidebar_label: Get Started with Replit
...
2. Connect your MetaMask wallet to the web interface and switch to the [Mumbai Testnet](docs/tools/wallets/metamask/config-polygon-on-metamask).
