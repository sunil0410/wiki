          ...
          <div className="row">
            ...
            <div className="row justify-content-center">
              <div className="col-lg-8">
                ...
                <h3 className="mt-0">Redefining Layer 2 Chain Development</h3>
                <p className="lead">
                  The <b>Chain Development Kit Wiki</b> is the documentation hub for Polygon CDK, providing comprehensive
                  documentation, community resources, and guides for enthusiasts and developers interested in learning
                  about or building a layer 2 chain with the CDK.
                </p>
              </div>
