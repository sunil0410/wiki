---
id: main
title: Introduction to the Miden Virtual Machine
...
In the reference section, we provide developer-focused documentation useful to those who want to develop on Miden VM or build compilers from higher-level languages to Miden VM.
...
For info on how to run programs on Miden VM, please refer to the [usage](/docs/miden/intro/usage.md) section in the introduction.
